...
class User extends Authenticatable
{
     ...
     * @var list<string>
     */
    protected $fillable = ['name','email','password','phone','gender','dob', 'xp', 'streak','streak_updated_for_date','is_admin','status','deactivated_at','last_login_at','tour_completed_at','is_plus','stripe_subscription_id','plus_expires_at','trial_ends_at','email_news','email_reminders','weekly_summary','private_profile'];
